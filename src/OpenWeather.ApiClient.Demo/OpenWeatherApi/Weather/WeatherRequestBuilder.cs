...
namespace OpenWeather.ApiClient.Demo.Weather
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::OpenWeather.ApiClient.Demo.Models.TwoZeroZero?> GetAsync(Action<RequestConfiguration<global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder.WeatherRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::OpenWeather.ApiClient.Demo.Models.TwoZeroZero> GetAsync(Action<RequestConfiguration<global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder.WeatherRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::OpenWeather.ApiClient.Demo.Models.TwoZeroZero>(requestInfo, global::OpenWeather.ApiClient.Demo.Models.TwoZeroZero.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Access current weather data for any location on Earth including over 200,000 cities! Current weather is frequently updated based on global models and data from more than 40,000 weather stations.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder.WeatherRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder.WeatherRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder WithUrl(string rawUrl)
        {
            return new global::OpenWeather.ApiClient.Demo.Weather.WeatherRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Access current weather data for any location on Earth including over 200,000 cities! Current weather is frequently updated based on global models and data from more than 40,000 weather stations.
        /// </summary>
...
#nullable restore
            ...
            [QueryParameter("lang")]
            public global::OpenWeather.ApiClient.Demo.Weather.GetLangQueryParameterType? Lang { get; set; }
...
#nullable restore
            ...
            [QueryParameter("mode")]
            public global::OpenWeather.ApiClient.Demo.Weather.GetModeQueryParameterType? Mode { get; set; }
...
#nullable restore
            ...
            public global::OpenWeather.ApiClient.Demo.Weather.GetUnitsQueryParameterType? Units { get; set; }
